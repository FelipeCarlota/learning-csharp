			...
			// 	//600
			// 	"DCI", "DCII", "DCIII", "DCIV", "DCV", "DVI", "DCVII", "DCVIII", "DIX", "DX",
			// 	"DCXI", "DCXII", "DCXIII", "DCXIV", "DCXV", "DCXVI", "DCXVII", "DCXVIII", "DXIX", "DXX",
			// 	"DCXXI", "DCXXII", "DCXXIII", "DCXXIV", "DCXXV", "DCXXVI", "DCXXVII", "DXXVIII", "DXXIX", "DXXX",
			// 	"DCXXXI", "DCXXXII", "DCXXXIII", "DCXXXIV", "DCXXXV", "DCXXXVI", "DXXXVII", "DXXXVIII", "DXXXIX", "DXL",
			// 	"DCXLI", "DCXLII", "DCXLIII", "DCXLIV", "DCXLV", "DCXLVI", "DXLVII", "DXLVIII", "DXLIX", "DL",
			...
			// for (int i = 0; i <= 5; i++) {
			// 	numerosRomanos.Add(algarismo[i], i+1);
