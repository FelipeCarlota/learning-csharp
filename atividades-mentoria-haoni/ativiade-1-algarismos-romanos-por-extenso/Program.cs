		...
		public static void Main(string[] args)
		{
			...
			if (soma < 6000) {
				if (numero.Contains("IIII") || numero.Contains("XXXX") || numero.Contains("CCCC") || 
				 ...
				 Console.WriteLine("Este número não é válido, entretanto, para os casos de numeros maiores do que mil, utilize a letra M. Lembrando que ele é representado pelo algarismo unitário e um risco em cima."); 
				}
				else
				{
					// Escreve por extenso
